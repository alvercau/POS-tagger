...
# it said before 'UNIGRAM' + unigram[0], but that gives just the first letter of each unigram in the output file,
# because the keys of the unigram_p dictionary are not tuples, so I deleted the [0]
